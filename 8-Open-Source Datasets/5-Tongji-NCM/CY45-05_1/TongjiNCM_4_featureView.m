...
%%% relaxation features (Uoc, R0, R1, C1, R2, C2) for downstream analysis.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   %% Relaxation-voltage extraction
    ...
    if ~ismember(IndexData,[])
      ...
      %% Health-feature construction
        ...
        % Optional manual bias adjustment for specific samples (kept as in original)
        if ismember(IndexData, [])
            Bias = 0.1;
...
save Feature_ALL_TongjiNCM.mat Uoc R0 R1 C1 R2 C2