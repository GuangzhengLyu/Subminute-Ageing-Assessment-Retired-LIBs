...
%%% leave-one-out Bayesian-regularized neural networks (trainbr) to predict
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            % Create a Bayesian-regularized feedforward network
            % Hidden layer sizes and training options are kept as provided
