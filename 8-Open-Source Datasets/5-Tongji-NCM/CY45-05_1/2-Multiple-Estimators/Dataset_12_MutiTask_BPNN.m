...
%%% leave-one-out backpropagation neural network (BPNN) regression to
%%% estimate all health indicators and save the test predictions to a MAT-file.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for CountSV = 14:-1:14 
    ...
    %% Repeated leave-one-out BPNN regression (newff + train + sim)
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            % BPNN (feedforward neural network) setup
            % Transfer functions: hidden layers (tansig), output layer (purelin)
