...
%%% leave-one-out extreme learning machine (ELM) regression to estimate all
...
for CountSV = 14:-1:14 
    ...
    %% Repeated leave-one-out ELM regression (elmtrain + elmpredict)
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            % Extreme Learning Machine (ELM) configuration
