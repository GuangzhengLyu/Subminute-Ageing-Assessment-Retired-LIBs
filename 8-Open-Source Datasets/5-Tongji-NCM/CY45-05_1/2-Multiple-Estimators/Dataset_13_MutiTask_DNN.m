...
%%% leave-one-out deep neural network (DNN) regression (trainNetwork) to
...
for CountSV = 14:-1:14 
    ...
    %% Repeated leave-one-out DNN regression (trainNetwork)
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            % DNN regression model definition (kept as in original script)
            layers = [
