...
%%% leave-one-out multi-task PLSR (single multi-output regression) to predict
...
for CountSV = 14:-1:14 
    ...
    %% Repeated leave-one-out multi-task PLSR
    % A single multi-output PLSR model is fitted for each split
    for CountRP = 1:100
