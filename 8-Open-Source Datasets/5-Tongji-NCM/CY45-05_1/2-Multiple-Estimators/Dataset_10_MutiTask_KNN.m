...
%%% leave-one-out k-nearest neighbors (KNN) regression (implemented via
%%% fitcknn + predict) to estimate all health indicators and save the test
...
for CountSV = 14:-1:14 
    ...
    %% Repeated leave-one-out KNN regression (fitcknn + predict)
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            % Note: fitcknn is used here as in the original script
