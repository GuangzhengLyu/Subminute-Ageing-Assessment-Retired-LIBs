...
%%% leave-one-out multi-task Bayesian linear regression using a custom closed-
%%% form posterior mean estimator. Predictions are clipped in the normalized
%%% space, de-normalized for visualization, and repeated test predictions
%%% (Y_Test) are saved to a MAT-file for downstream analysis.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            %% Set Bayesian regression hyperparameters (kept as original values)
            sigma_squared = 0.01; % Variance of output covariance
            eta_sqaured   = 0.02; % Variance of coefficient prior covariance

            %% Train model (posterior mean of Bayesian linear regression)
