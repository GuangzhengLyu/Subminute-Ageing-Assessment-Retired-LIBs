...
%%% run repeated leave-one-out multi-task BPNN regression using a feedforward
%%% neural network (newff) with specified transfer/training functions.
%%% Predictions are clipped in the normalized space, de-normalized for
%%% visualization, and saved as Y_Test for downstream evaluation.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            % Network configuration is kept as in the original script
