...
%%% leave-one-out multi-task KNN regression implemented via MATLAB KNN models.
%%% One KNN model is trained per output target using 3 neighbors and
%%% correlation distance. Predictions are clipped in the normalized space,
%%% de-normalized for visualization, and repeated test predictions (Y_Test)
%%% are saved to a MAT-file for downstream analysis.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            % Create KNN models (one regressor per output target)
