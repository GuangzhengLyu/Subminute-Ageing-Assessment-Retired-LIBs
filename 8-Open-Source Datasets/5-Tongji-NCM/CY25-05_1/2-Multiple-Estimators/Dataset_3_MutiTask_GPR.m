...
%%% leave-one-out multi-task GPR (fitrgp) to predict multiple ageing/health
%%% targets. Predictions are clipped in the normalized space, de-normalized
%%% for visualization, and the repeated test predictions (Y_Test) are saved
%%% to a MAT-file for downstream analysis.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            % Train GPR models (one GPR per output dimension)
