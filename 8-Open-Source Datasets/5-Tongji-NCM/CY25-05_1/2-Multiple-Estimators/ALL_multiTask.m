...
%%% This script: Batch-run multiple multi-task regression pipelines (MLR,
%%% PLSR, GPR, SVR, DT, RF, XGBoost, Bayes, BNN, KNN, ELM, BPNN, DNN, CNN).
%%% Each sub-script is executed in a clean MATLAB workspace to ensure that
%%% results are reproducible and not affected by residual variables.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% Run each modelling script with a clean workspace
clear,clc,close all
