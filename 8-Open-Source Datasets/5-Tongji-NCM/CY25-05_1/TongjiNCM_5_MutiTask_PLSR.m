...
%%% indicators, normalize inputs/outputs, and run repeated leave-one-out PLSR
%%% to predict multiple ageing/health targets. Results are saved per setting
%%% to MAT-files for downstream evaluation and visualization.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for CountSV = 14:-1:14 
    ...
    currentFile = sprintf('PLSR_Result_1_70_Y_Test_%d_TongjiNCM25.mat',CountSV);
