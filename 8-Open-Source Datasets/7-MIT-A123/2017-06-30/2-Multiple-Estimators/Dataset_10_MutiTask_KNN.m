...
%%% features, train per-task KNN models under repeated leave-one-out splits,
%%% visualize train/test scatter results, and save predicted test outputs to
%%% MAT-files.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for CountSV = 14:-1:14
    ...
    %% Repeated leave-one-out KNN regression (implemented via fitcknn + predict)
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            % Create and train KNN models (one model per output/task)
            % Note: The script uses correlation distance and k=3 (kept as-is)
