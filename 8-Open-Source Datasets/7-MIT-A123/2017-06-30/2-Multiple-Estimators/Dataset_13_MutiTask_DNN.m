...
%%% Dataset: 7-MIT-A123
%%% This script: Train a simple DNN regressor (fully-connected layers) on the
%%% MITA123_2 dataset using normalized relaxation features as inputs and six
%%% normalized health indicators as outputs. The workflow uses repeated
...
for CountSV = 14:-1:14
    ...
    %% Repeated leave-one-out DNN regression
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            %% DNN definition (fully-connected regression network)
            % Note: The layer choices are preserved from the original script
            layers = [
