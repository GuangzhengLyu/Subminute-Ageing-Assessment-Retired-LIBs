...
%%% features, train a BPNN (feedforward neural network) regressor under
...
for CountSV = 14:-1:14
    ...
    %% Repeated leave-one-out BPNN regression
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            %% BPNN (feedforward neural network) training and prediction
            % Network architecture and training settings are preserved as-is
