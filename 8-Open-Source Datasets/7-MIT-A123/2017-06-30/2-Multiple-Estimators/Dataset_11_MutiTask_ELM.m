...
%%% features, train an ELM-based multi-output regressor under repeated
...
for CountSV = 14:-1:14
    ...
    %% Repeated leave-one-out ELM regression
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            % Hidden-layer size and activation function are preserved as-is
