...
%%% This script: Assemble feature/output matrices, normalize inputs/outputs,
%%% and run repeated leave-one-out PLSR (with up to 5 latent components) to
%%% generate and save prediction results for downstream benchmarking.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for IndexData = 1:length(OneCycle)
    ...
    % Extended health indicators (kept as in original workflow)
...
for CountSV = 14:-1:14
    ...
    % Note: Max_In/Min_In define normalization bounds for the selected setting.
    ...
    currentFile = sprintf('PLSR_Result_1_80_Y_Test_%d_MITA123_3.mat',CountSV);
