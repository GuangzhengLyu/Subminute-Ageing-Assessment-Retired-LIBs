...
%%% relaxation features, and run repeated leave-one-out GPR (fitrgp) to
%%% generate and save prediction results for benchmarking.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            % Train GPR (one regressor per output dimension)
