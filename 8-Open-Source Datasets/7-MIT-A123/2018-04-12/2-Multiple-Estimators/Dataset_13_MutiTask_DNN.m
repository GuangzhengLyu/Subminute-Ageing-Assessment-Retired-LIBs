...
%%% relaxation features, and run repeated leave-one-out DNN regression
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            %% Deep neural network regression (fully-connected)
            % Note: The network is defined as a sequence model to match the
            % original script (sequenceInputLayer + trainNetwork).
            layers = [
