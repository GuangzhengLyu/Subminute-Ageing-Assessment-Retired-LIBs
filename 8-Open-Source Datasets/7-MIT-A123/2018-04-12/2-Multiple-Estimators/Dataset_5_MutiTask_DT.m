...
%%% relaxation features, and run repeated leave-one-out decision-tree
%%% regression (fitrtree; one tree per output) to generate and save results.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            % Train decision trees (one regressor per output dimension)
            trees = cell(6, 1);
            for i = 1:6
