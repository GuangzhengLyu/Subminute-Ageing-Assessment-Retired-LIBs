...
%%% relaxation features, and run repeated leave-one-out BPNN regression
%%% (newff / trainlm) to generate and save prediction results.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            % Network transfer functions (hidden / output) and training algorithm
            transform_func = {'tansig','purelin'};
            train_func = 'trainlm';

            % Create a multi-layer feed-forward network
