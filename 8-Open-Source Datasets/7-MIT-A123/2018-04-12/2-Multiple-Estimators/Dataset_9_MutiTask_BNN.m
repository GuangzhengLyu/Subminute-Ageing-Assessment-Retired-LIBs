...
%%% relaxation features, and run repeated leave-one-out Bayesian-regularized
%%% neural network regression (trainbr) to generate and save results.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            %% Bayesian regularization neural network (trainbr)
            % Network definition (kept as in original script)
