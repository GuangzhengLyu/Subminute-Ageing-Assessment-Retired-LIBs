...
%%% Dataset: 3-SDU-NCM
%%% This script: Load pre-extracted relaxation features (Uoc, R0, R1, C1, R2,
%%% C2) and construct normalized health indicators (capacity SOH, life length,
%%% and expanded performance indicators). Then run repeated leave-one-out PLSR
%%% training/testing to generate prediction results (Y_Test), and save them
%%% to MAT-files for downstream analysis/visualization.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%% Sample construction
% Collect target indicators for each cell/sample
CountData = 0;
...
for CountSV = 14:-1:14
    ...
    for CountRP = 1:100
        ...
        % Visualization: scatter plots (ground truth vs prediction)
        for IndOTrain = 1:6
    ...
    currentFile = sprintf('PLSR_Result_1_50_Y_Test_%d_SDU_NCM.mat',CountSV);
