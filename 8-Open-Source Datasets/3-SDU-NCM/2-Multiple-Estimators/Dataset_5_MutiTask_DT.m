...
%%% leave-one-out multi-task regression using Decision Trees (fitrtree).
%%% One regression tree is trained per output dimension. Prediction results
%%% (Y_Test) are saved to MAT-files for downstream analysis.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
