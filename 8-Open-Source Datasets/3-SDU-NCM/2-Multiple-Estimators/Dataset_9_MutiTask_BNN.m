...
%%% leave-one-out multi-task regression using a Bayesian-regularized neural
%%% network (trainbr). The network is trained per left-out sample and
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            % Two hidden layers with 10 and 5 neurons (kept as original)
            net = fitnet([10, 5], 'trainbr');  % two hidden layers: 20 and 10 neurons
