...
%%% leave-one-out multi-task regression using an Extreme Learning Machine
%%% (ELM). The ELM is trained per repeat using the provided ELM toolbox, and
%%% predictions (Y_Test) are saved to MAT-files for downstream analysis.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Add ELM toolbox functions to path
addpath('./11-ELM');
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            % Train a single ELM for all outputs using the toolbox API
