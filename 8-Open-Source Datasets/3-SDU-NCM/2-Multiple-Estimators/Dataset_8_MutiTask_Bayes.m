...
%%% leave-one-out multi-task regression using a simple Bayesian linear
%%% regression model. The Bayesian model is trained once per repeat and
%%% predicts all output dimensions jointly. Prediction results (Y_Test) are
%%% saved to MAT-files for downstream analysis.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            % Note: variable names and values are kept as original.
...
function mu = my_bayesian_regression(p_train, t_train, small_sigma_squared, eta_sqaured)
    ...
    % Construct prior covariance matrices
