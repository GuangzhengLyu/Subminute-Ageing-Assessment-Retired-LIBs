...
%%% leave-one-out multi-task regression using XGBoost. One XGBoost regressor
%%% is trained per output dimension using a fixed hyperparameter set.
...
% Add XGBoost toolbox (xgboost_train / xgboost_test)
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:2
        for IndexData = 1:length(Feature_Nor)
            ...
            %% XGBoost
            % Fixed hyperparameters (kept as original)
            num_trees = 100;
            params.eta = 0.1;
