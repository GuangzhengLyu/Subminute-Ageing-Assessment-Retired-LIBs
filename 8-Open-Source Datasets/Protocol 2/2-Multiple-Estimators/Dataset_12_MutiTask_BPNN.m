...
%%% evaluation using a backpropagation neural network (BPNN). The network is
%%% trained on each leave-one-out split, predictions are denormalized for
%%% visualization, and results are saved to MAT-files for downstream RMSE
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:100
        ...
        for IndexData = 1:length(Feature_Nor)
            ...
            % Train network on the current split
