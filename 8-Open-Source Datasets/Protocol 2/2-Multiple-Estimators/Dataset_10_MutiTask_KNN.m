...
%%% evaluation using k-nearest neighbors (KNN). One KNN model is trained per
%%% target indicator. Predictions are denormalized for visualization and
%%% saved to MAT-files for downstream RMSE/statistical analysis.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:100
        ...
        for IndexData = 1:length(Feature_Nor)
            ...
            % Create and train KNN regressors (one model per output indicator)
            % Note: fitcknn is used as in the original script; prediction returns numeric labels
