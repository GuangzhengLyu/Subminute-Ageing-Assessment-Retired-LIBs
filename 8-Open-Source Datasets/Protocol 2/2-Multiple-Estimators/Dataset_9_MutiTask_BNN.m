...
%%% evaluation using a Bayesian-regularized neural network (trainbr, fitnet).
%%% Predictions are denormalized for visualization and saved to MAT-files
%%% for downstream RMSE/statistical analysis.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
