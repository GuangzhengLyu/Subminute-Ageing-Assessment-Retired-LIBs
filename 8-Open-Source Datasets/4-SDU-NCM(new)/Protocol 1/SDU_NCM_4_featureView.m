...
for IndexData = 1:length(OneCycle)
  ...
  %% Relaxation-voltage extraction
    ...
    if ~ismember(IndexData,[])
        ...
        % Relaxation segment index (structure preserved for potential extension)
        CountRX = CountRX+1;

        % Drop a few initial relaxation points to avoid transient artifacts
        ...
        % Store relaxation voltage trace (keep indexing exactly as original)
...
save Feature_ALL_SDU_NCM_P1.mat Uoc R0 R1 C1 R2 C2