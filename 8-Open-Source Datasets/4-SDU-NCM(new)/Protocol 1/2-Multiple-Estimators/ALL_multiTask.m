...
%%% a predefined set of learning models (MLR/PLSR/GPR/SVR/DT/RF/XGBoost/
%%% Bayes/BNN/KNN/ELM/BPNN/DNN/CNN). Each sub-script is executed in a fresh
%%% workspace to avoid variable contamination and ensure reproducibility.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% Run multi-task models sequentially (reset workspace before each run)
clear,clc,close all
