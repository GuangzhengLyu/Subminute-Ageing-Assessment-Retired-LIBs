...
%%% run repeated leave-one-out cross-validation using multi-output decision
%%% trees (one regression tree per task), visualize train/test predictions,
%%% and save Y_Test for downstream evaluation.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            % 2. Train decision trees (one regression tree per output)
            trees = cell(6, 1);
