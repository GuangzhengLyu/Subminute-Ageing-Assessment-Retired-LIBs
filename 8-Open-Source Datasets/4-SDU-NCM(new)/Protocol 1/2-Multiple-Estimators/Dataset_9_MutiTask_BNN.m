...
%%% run repeated leave-one-out cross-validation using a Bayesian
%%% regularization neural network (trainbr) for multi-output regression,
%%% visualize train/test predictions, and save Y_Test for downstream
%%% evaluation.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            % 2. Create Bayesian-regularized neural network (multi-output regression)
