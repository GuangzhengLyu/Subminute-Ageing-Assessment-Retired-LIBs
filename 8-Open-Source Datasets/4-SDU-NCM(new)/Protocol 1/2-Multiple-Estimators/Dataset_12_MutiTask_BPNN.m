...
%%% run repeated leave-one-out cross-validation using a backpropagation
%%% neural network (BPNN, via newff/train/sim), visualize train/test
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            %% BPNN
            % Network structure and training settings are kept as in the original script
