...
%%% run repeated leave-one-out cross-validation using multi-output XGBoost
%%% (one boosted model per task), visualize train/test predictions, and save
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:2
        for IndexData = 1:length(Feature_Nor)
            ...
            % Train one boosted model per output dimension
