...
%%% run repeated leave-one-out cross-validation using multi-output GPR
%%% (separate Gaussian process models per task), visualize train/test
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            % Train separate GPR models for each task/output dimension
