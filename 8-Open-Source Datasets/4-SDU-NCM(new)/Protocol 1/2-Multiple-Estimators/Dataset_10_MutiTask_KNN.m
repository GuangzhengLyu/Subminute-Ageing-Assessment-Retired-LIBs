...
%%% run repeated leave-one-out cross-validation using KNN regressors
%%% (implemented via fitcknn), visualize train/test predictions, and save
%%% Y_Test for downstream evaluation.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            % Prediction on training set and test sample
