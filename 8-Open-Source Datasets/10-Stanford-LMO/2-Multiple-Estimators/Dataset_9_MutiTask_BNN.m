...
%%% Bayesian regularized neural network regression (trainbr) to predict six
%%% ageing indicators. Predicted test outputs (Y_Test) are saved to MAT-files
%%% for downstream evaluation and result aggregation.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:100
        ...
        for IndexData = 1:length(Feature_Nor)
            ...
            net.trainParam.epochs = 20;        % fixed epoch cap (kept as in original)
