...
%%% backpropagation neural network (BPNN) regression to predict six ageing
%%% indicators. Predicted test outputs (Y_Test) are saved to MAT-files for
%%% downstream evaluation and result aggregation.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:100
        ...
        for IndexData = 1:length(Feature_Nor)
            ...
            % Network configuration is kept as in the original script (newff)
            transform_func = {'tansig','purelin'};
            train_func = 'trainlm';
            net = newff(In_Train,Out_Train,[6,20,10,6],transform_func,train_func);

            % Training hyperparameters (kept unchanged)
            net.trainParam.epochs = 100000000;
            net.trainParam.lr = 0.001;
            net.trainParam.goal = 0.0001;

            % Train and predict (normalized space)
