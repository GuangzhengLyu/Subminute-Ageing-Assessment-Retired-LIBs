...
%%% PLSR to predict six ageing indicators. Predicted test outputs (Y_Test)
%%% are saved to MAT-files for downstream evaluation and result aggregation.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
