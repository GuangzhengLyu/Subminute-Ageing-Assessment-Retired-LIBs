...
%%% deep neural network (DNN) regression (trainNetwork) to predict six ageing
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:100
        ...
        for IndexData = 1:length(Feature_Nor)
            ...
            %% Multi-task DNN regression (Deep Learning Toolbox)
            % Define a simple fully connected network for 6-D input -> 6-D output
            layers = [
