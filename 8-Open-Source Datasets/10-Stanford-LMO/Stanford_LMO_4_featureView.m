...
for IndexData = 1:length(OneCycle)
  ...
  %% Relaxation-voltage extraction
    ...
    if ~ismember(IndexData,[])
        ...
        % Optional trimming of initial relaxation points (kept as in original)
        LengthDrop = 100; % LengthDrop = 0;
        LengthCops = 0;
...
save Feature_ALL_Stanford_LMO.mat Uoc R0 R1 C1 R2 C2