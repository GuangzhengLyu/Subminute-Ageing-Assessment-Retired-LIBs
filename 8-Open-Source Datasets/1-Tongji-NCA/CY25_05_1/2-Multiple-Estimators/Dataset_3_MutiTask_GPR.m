...
%%% then run repeated leave-one-out evaluation using multi-output GPR
%%% (fitrgp + predict) at a selected voltage setpoint and save test
%%% predictions to a MAT-file.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            % Ensure 2-D shapes are consistent for fitrgp/predict inputs
            ...
            %% Train multi-output GPR models (one model per output)
            ...
            %% Prediction (normalized output space)
