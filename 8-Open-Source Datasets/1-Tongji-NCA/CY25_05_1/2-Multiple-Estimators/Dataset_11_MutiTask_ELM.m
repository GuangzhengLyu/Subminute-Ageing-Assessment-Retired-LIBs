...
%%% then run repeated leave-one-out evaluation using an Extreme Learning
%%% Machine (ELM). Models are trained on normalized inputs/outputs and
...
% ELM library functions (elmtrain / elmpredict)
addpath('./11-ELM');
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            % ELM hyperparameters (kept as in original script)
            num_hiddens = 10;        % Number of hidden nodes
