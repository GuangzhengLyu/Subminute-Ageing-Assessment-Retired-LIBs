...
%%% then run repeated leave-one-out evaluation using multi-output MLR
%%% (fitlm + predict) at a selected voltage setpoint and save test
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            % Ensure 2-D shapes are consistent for fitlm/predict inputs
            ...
            %% Train multi-output MLR models (one model per output)
