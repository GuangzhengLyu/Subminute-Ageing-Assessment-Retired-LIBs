...
%%% then run repeated leave-one-out PLSR evaluation at a selected voltage
%%% setpoint and save test predictions to a MAT-file.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% used during PLSR training/prediction below.
Capa = Capa/3.5;
Life = Life;
ERate = ERate/0.92;
...
%% Repeated LOOCV evaluation (PLSR)
