...
%%% then run repeated leave-one-out evaluation using a Backpropagation Neural
%%% Network (BPNN). Models are trained on normalized inputs/outputs and
%%% predictions are de-normalized back to the original scales. Test-set
%%% predictions are saved to a MAT-file for downstream comparison across
%%% models.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%% Repeated LOOCV evaluation (BPNN)
...
for CountSV = 14:-1:14
    ...
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            % Network configuration (kept as in original script):
            % - transfer functions: hidden layer(s) 'tansig', output 'purelin'
