...
%%% repeated leave-one-out multi-task regression workflow using Gaussian
%%% Process Regression (fitrgp). The test predictions (Y_Test) are saved as
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            % Ensure 2D matrix shapes expected by fitrgp/predict
            ...
            % Train GPR models (one GP regressor per output)
