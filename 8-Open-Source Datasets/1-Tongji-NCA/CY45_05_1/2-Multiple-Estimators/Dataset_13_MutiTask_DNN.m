...
%%% feedforward deep network implemented with Deep Learning Toolbox
%%% (trainNetwork/predict). Test predictions (Y_Test) are saved as MAT-files
%%% for downstream evaluation and visualization.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            % Ensure 2D matrix shapes expected by trainNetwork/predict
            ...
            %% Deep Learning Toolbox regression network (fully connected)
            % NOTE: Layer graph and training options are kept as in the original script.
            layers = [
