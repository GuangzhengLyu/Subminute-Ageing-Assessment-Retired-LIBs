...
%%% repeated leave-one-out multi-task regression workflow using an Extreme
%%% Learning Machine (ELM). The ELM implementation is provided via external
%%% functions (elmtrain/elmpredict). Test predictions (Y_Test) are saved as
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            % Ensure 2D matrix shapes expected by the ELM toolbox
            ...
            activate_model = 'sig';  % activation function type
