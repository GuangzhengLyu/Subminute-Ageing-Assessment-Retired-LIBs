...
%%% repeated leave-one-out multi-task regression workflow using a classic
%%% backpropagation neural network (BPNN) built with Neural Network Toolbox
%%% (newff/train/sim). Test predictions (Y_Test) are saved as MAT-files for
%%% downstream evaluation and visualization.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            % Ensure 2D matrix shapes expected by newff/train/sim
            ...
            % NOTE: Network definition and training hyperparameters are kept
