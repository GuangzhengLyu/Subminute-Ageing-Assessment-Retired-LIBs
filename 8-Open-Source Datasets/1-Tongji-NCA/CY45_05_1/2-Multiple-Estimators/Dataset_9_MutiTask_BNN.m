...
%%% repeated leave-one-out multi-task regression workflow using a Bayesian
%%% regularized neural network (fitnet with trainbr). The neural network is
%%% trained to map relaxation features to six health indicators, and test
%%% predictions (Y_Test) are saved as MAT-files for downstream evaluation
%%% and visualization.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            % Ensure 2D matrix shapes expected by fitnet/train
            ...
            % Create Bayesian regularized neural network (trainbr)
            % Network architecture: 2 hidden layers with 10 and 5 neurons
