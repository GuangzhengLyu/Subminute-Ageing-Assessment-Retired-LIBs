...
%%% leave-one-out deep neural network (DNN) regression using RC relaxation
%%% features as inputs. Predictions are de-normalized for visualization and
%%% saved to MAT files.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for CountSV = 14:-1:14 
    ...
    %% Repeated leave-one-out DNN regression (multi-output)
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            % Define a simple fully-connected regression network
            % NOTE: sequenceInputLayer is kept as in the original code, although the
            % data are provided as numeric matrices (6×N). This is consistent with
            % your current implementation and is not changed here.
            layers = [
            ...
            % Predict on training and the held-out test sample
