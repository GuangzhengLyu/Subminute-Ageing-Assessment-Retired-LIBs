...
%%% leave-one-out backpropagation neural network (BPNN) regression using RC
%%% relaxation features as inputs. Predictions are de-normalized for
%%% visualization and saved to MAT files.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for CountSV = 14:-1:14 
    ...
    %% Repeated leave-one-out BPNN regression (multi-output)
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            % BPNN (feed-forward network trained via backpropagation)
