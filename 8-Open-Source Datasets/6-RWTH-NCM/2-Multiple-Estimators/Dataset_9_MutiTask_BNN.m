...
%%% leave-one-out Bayesian-regularized neural network regression (BNN via
%%% trainbr) using RC relaxation features as inputs. A single multi-output
%%% network is trained to jointly predict all targets. Predictions are
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            % 2. Create Bayesian-regularized neural network (multi-output)
