...
%%% leave-one-out XGBoost regression using RC relaxation features as inputs.
%%% One XGBoost model is trained per target. Predictions are de-normalized
%%% for visualization and saved to MAT files.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for CountSV = 14:-1:14 
    ...
    %% Repeated leave-one-out XGBoost regression (multi-task via separate heads)
    for CountRP = 1:2
