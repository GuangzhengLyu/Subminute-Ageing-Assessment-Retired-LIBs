...
%%% inputs, apply min-max normalization, and run repeated leave-one-out
%%% multi-output MLR (fitlm) to generate predictions saved as MAT-files.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            %% Multi-output MLR training (fitlm)
            % Fit one linear regression model per target output
