...
%%% leave-one-out CNN regression using trainNetwork with an imageInputLayer.
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            % Assemble CNN test input in 4-D format: H × W × C × N
            ...
            % Assemble CNN training input in 4-D format: H × W × C × N
            for NumST = 1:size(Temp_F,3)
