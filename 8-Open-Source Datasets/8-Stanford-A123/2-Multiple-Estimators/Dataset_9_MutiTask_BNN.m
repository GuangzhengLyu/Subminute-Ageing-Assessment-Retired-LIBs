...
%%% leave-one-out Bayesian-regularized neural network regression (trainbr).
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            %% Bayesian-regularized neural network (trainbr)
            % Create a two-hidden-layer network (kept as in the original script)
            net = fitnet([10, 5], 'trainbr');  % Two hidden layers: 10 and 5 neurons
