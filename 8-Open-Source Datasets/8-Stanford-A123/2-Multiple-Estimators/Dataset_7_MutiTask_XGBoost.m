...
%%% leave-one-out XGBoost regression (MATLAB wrapper). Predictions are saved
%%% as MAT-files for downstream benchmarking.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Add XGBoost library functions (MATLAB wrapper)
addpath('./7-XGBoost');
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:2
        for IndexData = 1:length(Feature_Nor)
            ...
            % Note: Parameters are kept as in the original script.
            num_trees = 100;
            params.eta = 0.1;
            ...
            % Train one XGBoost model per output
