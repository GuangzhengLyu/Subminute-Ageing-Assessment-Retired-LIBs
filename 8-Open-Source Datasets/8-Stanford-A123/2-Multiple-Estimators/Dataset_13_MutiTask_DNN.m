...
%%% leave-one-out deep neural network (DNN) regression using trainNetwork.
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            % Enforce explicit 2D shapes (kept as in original script)
            ...
            %% Deep neural network (DNN) definition and training
            layers = [
