...
%%% This script: Assemble relaxation-parameter features and extended health
%%% indicators, apply normalization/denormalization, and run repeated
%%% leave-one-out PLSR to generate prediction results saved as MAT-files.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Note: Keep the original scaling factors to ensure consistent normalization.
Capa = Capa/1.1;
Life = Life;
ERate = ERate/0.89;
...
for CountSV = 14:-1:14
    ...
    currentFile = sprintf('PLSR_Result_1_80_Y_Test_%d_MITA123_4.mat',CountSV);
