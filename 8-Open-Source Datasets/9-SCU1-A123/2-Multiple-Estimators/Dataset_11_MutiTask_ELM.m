...
%%% leave-one-out multi-task Extreme Learning Machine (ELM) regression to
%%% predict the six outputs from the normalized relaxation features.
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            %% ELM
            % Configure ELM hyperparameters (kept as in original script)
