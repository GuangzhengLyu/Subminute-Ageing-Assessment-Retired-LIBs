...
%%% leave-one-out multi-task XGBoost regression to predict the six outputs
%%% from the normalized relaxation features. Predictions (Y_Test) are saved.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Add XGBoost MATLAB wrapper path
addpath('./7-XGBoost');
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:2
        for IndexData = 1:length(Feature_Nor)
            ...
            %% XGBoost
            % Model settings (kept as in original script)
            num_trees = 100;
            params.eta = 0.1;
            ...
            % Train one XGBoost model per output dimension
