...
%%% leave-one-out multi-task KNN regression (via fitcknn) to predict the six
%%% outputs from the normalized relaxation features. Predictions (Y_Test)
%%% are saved to file.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            % Create and train KNN models (one per output dimension)
