...
%%% leave-one-out multi-task Decision Tree regression (fitrtree) to predict
%%% the six outputs from the normalized relaxation features.
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            % 2. Train Decision Trees (one tree per output dimension)
            trees = cell(6, 1);
