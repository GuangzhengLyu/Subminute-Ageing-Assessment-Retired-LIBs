...
%%% leave-one-out multi-task Bayesian-regularized neural network regression
%%% (fitnet + trainbr) to predict the six outputs from the normalized
%%% relaxation features. Predictions (Y_Test) are saved to file.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for CountSV = 14:-1:14 
    ...
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            % 2. Create Bayesian-regularized neural network
            % Two hidden layers with 10 and 5 neurons (kept as in original script)
