...
%%% Dataset: 2-RWTH-NCA
%%% This script: Assemble relaxation features and expanded health indicators,
%%% normalize inputs/outputs, and run repeated leave-one-out multi-task CNN
%%% regression (imageInputLayer + conv/pooling + FC) using trainNetwork.
  ...
  %% Input feature normalization
    ...
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            % CNN input formatting (kept as original operations)
          ...
          %% Convolutional Neural Network (CNN)
            % Define a compact CNN for regression on the formatted feature "image"
            layers = [
            ...
            % Training options (Adam optimizer; silent training; no plots)
