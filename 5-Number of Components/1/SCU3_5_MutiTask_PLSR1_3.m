...
%%% voltage setpoint using a fixed latent component number (ncomp = 1).
%%% For RUL-related training consistency, samples from the same test channel
%%% are excluded from the training set, and test-set predictions are saved.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%         end
    ...
    currentFile = sprintf('PLSR1_Result_3_50_Y_Test_%d.mat',CountSV);
