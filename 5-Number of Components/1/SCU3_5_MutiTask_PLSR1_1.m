...
%%% This script: Assemble SCU3 Dataset #1 samples, scale/normalize multi-
%%% dimensional health outputs, then run repeated leave-one-out PLSR for each
%%% voltage setpoint using a fixed latent component number (ncomp = 1) and
%%% save test-set predictions for downstream sensitivity analysis.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for CountSV = 13:-1:1
    ...
    % CountRP: repetition index (note: LOOCV split is deterministic here unless
    % randomness is introduced elsewhere; repetition loops are preserved as-is).
    for CountRP = 1:100
...
%         end
    ...
    currentFile = sprintf('PLSR1_Result_1_70_Y_Test_%d.mat',CountSV);
