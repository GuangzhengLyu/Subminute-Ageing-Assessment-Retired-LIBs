...
%%% This script: Assemble SCU3 Dataset #2 samples, scale/normalize multi-
...
%%% Test-set predictions are saved per setpoint for downstream sensitivity
%%% analysis across latent component settings.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%         end
    ...
    currentFile = sprintf('PLSR3_Result_2_60_Y_Test_%d.mat',CountSV);
