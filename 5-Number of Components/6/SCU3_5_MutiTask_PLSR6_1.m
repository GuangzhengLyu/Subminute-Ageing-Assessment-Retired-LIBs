...
%%% SCU3 Dataset #1, then run repeated leave-one-out PLSR (max 6 components)
...
for CountSV = 13:-1:1 
    ...
    % Outer loop: repetition index (CountRP)
    % Inner loop: LOOCV index over samples (IndexData)
    for CountRP = 1:100
...
%         end
    ...
    currentFile = sprintf('PLSR6_Result_1_70_Y_Test_%d.mat',CountSV);
