...
%%% This script: Load SCU3 Dataset #2, assemble normalized health indicators,
%%% then read saved PLSR5 prediction results across voltage setpoints to
...
for i = 1:13
    currentFile = sprintf('./PLSR5_Result_2_60_Y_Test_%d.mat',i);
    load(currentFile)
    for j = 1:100
