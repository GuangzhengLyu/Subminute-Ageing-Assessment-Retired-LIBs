...
%%% This script: Full RC feature set (Uoc, R0, R1, C1, R2, C2) -> PLSR
...
for CountSV = 13:-1:1  
    ...
    for CountRP = 1:100
        for IndexData = 1 :length(Feature_Nor)
            ...
            % For RUL-related prediction, use samples from different channels as training data only
            CountSamChannel = 0;
            ...
            ncomp = min(3, size(In_Train,1));  % at most 3 components
