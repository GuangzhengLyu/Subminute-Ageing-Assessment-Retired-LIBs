...
%%% This script: Evaluate 4RC-based PLSR predictions on SCU3 Dataset #1
...
for IndexData = 1:length(OneCycle)
    if OneCycle(IndexData).Steps(end) == 30
        ...
        % RUL proxy: first cycle index where discharge capacity drops below threshold (2.5 Ah)
...
for i = 1:13
    currentFile = sprintf('./PLSR_Result_1_70_Y_Test_%d_4RC.mat',i);
    load(currentFile)
