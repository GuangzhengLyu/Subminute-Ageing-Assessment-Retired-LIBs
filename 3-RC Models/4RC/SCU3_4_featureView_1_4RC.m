...
%%% R3, C3, R4, C4) from SCU3 Dataset #1 by fitting a 4-exponential decay
        ...
        if ~ismember(IndexData,[])
            ...
            for Vset = MyVoltege:0.1:4.2
                ...
                if MyData(1)-Vset(1) < 0
                    ...
                    if ismember(IndexData, [1,7,10,12,17,19,29,35,41,45,46,47,56,67,80,86,87,91,92,94])
                        Bias = 0.3;
                    elseif ismember(IndexData, [20,36,53,63,95])
                        Bias = 0.8;
                    elseif ismember(IndexData, [28,70,83,88])
                        Bias = 0.6;
