...
%%% This script: Evaluate 4RC-based PLSR predictions on SCU3 Dataset #3
...
for IndexData = 1:length(OneCycle)
    if OneCycle(IndexData).Steps(end) == 30
        ...
        % RUL proxy: first cycle index where discharge capacity drops below threshold (1.75 Ah)
...
for i = 1:13
    currentFile = sprintf('./PLSR_Result_3_50_Y_Test_%d_4RC.mat',i);
    load(currentFile)
