...
%%% (Uoc, R0, R1, C1, R2, C2, R3, C3) from SCU3 Dataset #1.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for IndexData = 1:length(OneCycle)
    ...
    if OneCycle(IndexData).Steps(end) == 30
        ...
        % Placeholder for excluding selected samples (empty list keeps all)
        if ~ismember(IndexData,[])
            ...
            for Vset = MyVoltege:0.1:4.2
                ...
                if MyData(1)-Vset(1) < 0
                    ...
                    if ismember(IndexData, [5,6,10,14,15,25,33,40,50,54,57,59,61,69,72,74,78,85,94,97,101])
                        Bias = 0.3;
                    elseif ismember(IndexData, [28,35])
                        Bias = 0.8;
