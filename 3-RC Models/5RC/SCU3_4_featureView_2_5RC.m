...
%%% This script: Extract 5RC features (Uoc, R0, R1–R5, C1–C5) from SCU3 Dataset #2
...
Set_Not05 = [1,3,4,12,13,19,23,24,25,27,31,32,33,34,35,36,39,40,41,43];
Set_Not03 = [1,13,19,24,25,27,31,35,36,40,41];
Set_Not08 = [1,13,19,27,35,36,40];
Set_Not06 = [1,13,19,27,36,40];
Set_Not04 = [1,19,27,36,40];
Set_Not07 = [1,19,27,36,40];
Set_Not09 = [1,19,27,36];
Set_Not02 = [19,27,36];
Set_Not10 = [19,27,36];
Set_Not01 = [19,27,36];
...
for IndexData = 1:length(OneCycle)
    ...
    if OneCycle(IndexData).Steps(end) == 30
        ...
        % RUL proxy: first cycle index where discharge capacity drops below 2.1 Ah
