...
%%% This script: Aggregate RMSE results for SCU3 Dataset #2 from saved
%%% 5-RC PLSR prediction files and compute a normalized multi-task score.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%% Sample construction
% Select valid samples (Steps(end) == 30)
...
%% RMSE aggregation (13 setpoints × 100 repeats)
for i = 1:13
    currentFile = sprintf('./PLSR_Result_2_60_Y_Test_%d_5RC.mat',i);
    load(currentFile)
...
%% Example parity/error plots (uses last loaded setpoint and last repeat)
...
%% Voltage setpoints (3.0–4.2 V)
Uter = 3.0:0.1:4.2;

%% Normalized multi-task RMSE score
