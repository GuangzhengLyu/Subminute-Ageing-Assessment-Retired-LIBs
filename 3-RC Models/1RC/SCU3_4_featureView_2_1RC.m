...
%%% SCU3 Dataset #2 by fitting a single-exponential relaxation model at
...
for i = 13:-1:1
    ...
    figure(1),clf,plot(Capa,Uoc(:,indexRX),'o')
    figure(2),clf,plot(Capa,R0(:,indexRX),'d')
    figure(3),clf,plot(Capa,R1(:,indexRX),'<')
    figure(4),clf,plot(Capa,C1(:,indexRX),'>')
end