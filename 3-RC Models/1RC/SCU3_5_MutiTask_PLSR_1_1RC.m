...
%%% assessment on SCU3 Dataset #1 with leave-one-out CV repeated 100 times.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% SCU3 Dataset #1
% Load structured single-cycle dataset
load('../../OneCycle_1.mat')
load('Feature_1_ALL_1RC.mat')
...
for CountSV = 13:-1:1
    ...
    Max_In = [4.10, 0.055,0.035, 900;
              4.01, 0.05, 0.03,  1000;
              3.92, 0.05, 0.027, 1200;
              3.82, 0.05, 0.027, 1300;
              3.73, 0.05, 0.026, 1400;
              3.62, 0.05, 0.026, 1500;
              3.52, 0.055,0.03,  1400;
              3.4,  0.07, 0.04,  1100;
              3.27, 0.08, 0.035, 750;
              3.2,  0.08, 0.035, 700;
              3.2,  0.08, 0.03,  700;
    ...
    Min_In = [4.05, 0.03, 0.024, 600;
              3.95, 0.03, 0.018, 600;
              3.87, 0.03, 0.015, 700;
              3.77, 0.03, 0.014, 700;
              3.67, 0.03, 0.014, 700;
              3.57, 0.033,0.013, 700;
              3.46, 0.035,0.015, 600;
              3.32, 0.04, 0.02,  500;
              3.21, 0.045,0.02,  400;
              3.1,  0.05, 0.015, 300;
              3.0,  0.05, 0.01,  200;
    ...
    currentFile = sprintf('PLSR_Result_1_70_Y_Test_%d_1RC.mat',CountSV);
