...
This folder contains the full implementation of the proposed ageing assessment framework described in the main manuscript (Fig. 1–5). It includes deep-ageing observation, pulse-inspection relaxation voltage analysis, internal-state feature extraction, multi-task PLSR modelling, and visualization of assessment results.
...
**Input:** `OneCycle_x.mat`

---

### Stage 2: Expanded Performance Indicators  
`SCU3_2_PIView_1/2/3.m`
...
**Output:**  
- Assessment results saved into `Result/`
