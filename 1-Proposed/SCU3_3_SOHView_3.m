...
%%% This script: Build a filtered sample set from SCU3 Dataset #3, compute
...
% Group samples into 0.1 Ah bins starting from 2.0 Ah, and collect indicator
% values within each bin for subsequent normalization and statistics.
InCaCo = 0;
for InCa = 2.0:0.1:2.4
    InCaCo = InCaCo+1;
