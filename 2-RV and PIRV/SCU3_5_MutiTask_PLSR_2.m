...
%%%          Relaxation Voltage
%%% This script: Load SCU3 Dataset #2 and EC-model features (Uoc, R0, R1, C1,
...
for CountSV = 14:-1:14 
    ...
    Max_In = [4.17, 0.001,  0.05,   25000, 0.01,  25000];
    Min_In = [4.09, 0.0065, 0.005,  0,     0.001, 0];
    ...
    currentFile = sprintf('./Result/PLSR_Result_2_60_Y_Test_%d.mat',CountSV);
