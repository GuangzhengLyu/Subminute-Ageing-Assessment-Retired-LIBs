...
%%% SCU3 Dataset #3, fit a two-exponential relaxation model, and construct
...
for IndexData = 1:length(OneCycle)
    ...
    if OneCycle(IndexData).Steps(end) == 30
        ...
        if ~ismember(IndexData,[])
            ...
            if ismember(IndexData, [22,66,87,88,118,121,133,214,253,277,376,391,414])
                Bias = 0.1;
            elseif ismember(IndexData, [234])
                Bias = 0.2;
