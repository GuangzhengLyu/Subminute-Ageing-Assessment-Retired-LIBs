...
%%% This script: Post-process DNN predictions on SCU3 Dataset #3 (terminal-voltage sweep).
...
for IndexData = 1:length(OneCycle)
    if OneCycle(IndexData).Steps(end) == 30
        ...
        % Life: first cycle index where discharge capacity drops below 1.75 Ah
...
for i = 1:13
    currentFile = sprintf('DNN_Result_3_50_Y_Test_%d.mat', i);
