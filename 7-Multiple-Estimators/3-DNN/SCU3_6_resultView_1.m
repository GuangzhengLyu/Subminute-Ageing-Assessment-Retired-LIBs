...
%%% This script: Post-process DNN predictions on SCU3 Dataset #1 (terminal-voltage sweep).
...
for IndexData = 1:length(OneCycle)
    if OneCycle(IndexData).Steps(end) == 30
        ...
        % Life: first cycle index where discharge capacity drops below 2.5 Ah
...
for i = 1:13
    currentFile = sprintf('DNN_Result_1_70_Y_Test_%d.mat', i);
