...
%%% for SCU3 Dataset #1, then run repeated leave-one-out BPNN (feedforward NN)
%%% across multiple voltage setpoints and save prediction results.
%%% Note: A separate BPNN is trained per leave-one-out split, using the
%%% Neural Network Toolbox (newff/trainlm/sim).
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for CountSV = 13:-1:1 
    ...
    currentFile = sprintf('BPNN_Result_1_70_Y_Test_%d.mat',CountSV);
