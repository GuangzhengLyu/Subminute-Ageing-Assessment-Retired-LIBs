...
%%% File: Summarize SVR prediction RMSE versus terminal voltage for SCU3 Dataset #2
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

clear
clc

%% Load dataset (SCU3 Dataset #2)
load('../../OneCycle_2.mat')
...
for i = 1:13
    currentFile = sprintf('SVR_Result_2_60_Y_Test_%d.mat',i);
    load(currentFile)
    for j = 1:100
