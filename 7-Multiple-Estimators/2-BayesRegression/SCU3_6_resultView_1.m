...
%%% This script: Post-process Bayesian regression (BR) prediction results for
%%% SCU3 Dataset #1 by loading saved Y_Test files, computing per-task RMSE
%%% across repetitions and voltage setpoints, plotting mean RMSE curves, and
%%% saving the aggregated RMSE matrix (M_RMSE).
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% SCU3 Dataset #1
% Load structured single-cycle dataset (used to reconstruct ground-truth outputs)
load('../../OneCycle_1.mat')
...
for i = 1:13
    currentFile = sprintf('Bayes_Result_1_70_Y_Test_%d.mat',i);
    load(currentFile)
    for j = 1:100
...
save M_RMSE_Bayes_1.mat M_RMSE