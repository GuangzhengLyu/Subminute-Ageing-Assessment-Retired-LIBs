...
%%% SCU3 Dataset #2 by loading saved Y_Test files, computing per-task RMSE
...
for i = 1:13
    currentFile = sprintf('Bayes_Result_2_60_Y_Test_%d.mat',i);
    load(currentFile)
    for j = 1:100
...
save M_RMSE_Bayes_2.mat M_RMSE