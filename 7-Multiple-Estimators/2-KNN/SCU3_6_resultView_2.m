...
%%% This script: Summarize KNN results on SCU3 Dataset #2 (updated file: OneCycle_2_260102.mat).
...
for i = 1:13
    currentFile = sprintf('KNN_Result_2_60_Y_Test_%d.mat', i);
