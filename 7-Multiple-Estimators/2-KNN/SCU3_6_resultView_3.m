...
%%% This script: Summarize KNN results on SCU3 Dataset #3 (updated file: OneCycle_3_260102.mat).
...
for i = 1:13
    currentFile = sprintf('KNN_Result_3_50_Y_Test_%d.mat', i);
