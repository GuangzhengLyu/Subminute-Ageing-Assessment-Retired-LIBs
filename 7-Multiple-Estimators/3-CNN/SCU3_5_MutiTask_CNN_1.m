...
%%% This script: Train and evaluate a CNN estimator on SCU3 Dataset #1.
...
for CountSV = 13:-1:1
    ...
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            % In_Test has shape [numFeatures, 6, 1, 1], where the first
            % dimension indexes feature channels (here size(Temp_F,3)=1)
            % and the second dimension indexes the 6 features.
            ...
            % Build training tensor: [numFeatures, 6, 1, numTrainSamples]
            for NumST = 1:size(Temp_F,3)
    ...
    currentFile = sprintf('CNN_Result_1_70_Y_Test_%d.mat',CountSV);
