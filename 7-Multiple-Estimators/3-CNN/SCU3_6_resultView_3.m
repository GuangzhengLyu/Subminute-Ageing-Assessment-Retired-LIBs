...
%%% This script: Post-process CNN results on SCU3 Dataset #3.
%%% It reconstructs six ground-truth targets (SOH, life/RUL proxy, and four
...
for i = 1:13
    currentFile = sprintf('CNN_Result_3_50_Y_Test_%d.mat',i);
