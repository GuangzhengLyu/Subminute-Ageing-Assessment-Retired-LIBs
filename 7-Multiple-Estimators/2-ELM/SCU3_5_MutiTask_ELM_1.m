...
%%% regression for SCU3 Dataset #1 across multiple relaxation-voltage
%%% setpoints, and save the predicted outputs for each setpoint.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for CountSV = 13:-1:1 
    ...
    currentFile = sprintf('ELM_Result_1_70_Y_Test_%d.mat',CountSV);
