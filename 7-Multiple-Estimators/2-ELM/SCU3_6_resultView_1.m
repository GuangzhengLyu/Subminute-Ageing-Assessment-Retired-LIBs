...
%%% This script: Load SCU3 Dataset #1, compute scaled health indicators,
...
% 2) RUL proxy (cycle index to capacity threshold),
...
for i = 1:13
    currentFile = sprintf('ELM_Result_1_70_Y_Test_%d.mat',i);
    load(currentFile)
