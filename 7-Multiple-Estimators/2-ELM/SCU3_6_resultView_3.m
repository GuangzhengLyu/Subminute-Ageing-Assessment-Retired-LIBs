...
%%% This script: Load SCU3 Dataset #3, compute scaled health indicators,
...
% 2) RUL proxy (cycle index to capacity threshold 1.75 Ah),
...
for i = 1:13
    currentFile = sprintf('ELM_Result_3_50_Y_Test_%d.mat',i);
    load(currentFile)
