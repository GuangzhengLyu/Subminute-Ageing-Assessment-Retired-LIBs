...
%%% SCU3 Dataset #1 across voltage setpoints, then save the mean RMSE traces.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for i = 1:13
    currentFile = sprintf('./5/PLSR_Result_1_70_Y_Test_%d.mat', i);
    load(currentFile)
