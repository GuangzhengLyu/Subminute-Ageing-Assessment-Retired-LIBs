...
%%% for SCU3 Dataset #1 by loading saved Y_Test files, computing per-task RMSE
...
for i = 1:13
    currentFile = sprintf('BNN_Result_1_70_Y_Test_%d.mat',i);
    load(currentFile)
    for j = 1:100
