...
%%% outputs for SCU3 Dataset #1, then run repeated leave-one-out evaluation
...
for CountSV = 13:-1:1
    ...
    for CountRP = 1:100
        for IndexData = 1:length(Feature_Nor)
            ...
            % 3. Train on the current LOOCV training split
    ...
    currentFile = sprintf('BNN_Result_1_70_Y_Test_%d.mat',CountSV);
